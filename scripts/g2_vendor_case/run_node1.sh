#!/bin/bash
# Vendor case launcher — node1 (141.61.95.30 / srv_28 / superpod_16383).
# Usage: ./run_node1.sh {push|pull|tunnel} [engine]
set -eu
CASE=${1:-push}
ENGINE=${2:-udma}
...
exec torchrun --nnodes=2 --nproc_per_node=1 --node_rank=1 \
