...
fc1_output_ptr, fc1_scale_ptr, recv_expert_offs_ptr, recv_seg_starts_ptr, signal_epoch, situ_beta, situ_linear_beta, clamp_limit,
...
recv_seg_starts_ptr, signal_epoch, situ_beta, situ_linear_beta, clamp_limit,
...
num_routes, signal_epoch, situ_beta, situ_linear_beta, clamp_limit,
